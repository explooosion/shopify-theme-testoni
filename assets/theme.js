  ...
  var HeaderSection = function () {
    ...
    _createClass(HeaderSection, [{
      ...
      value: function _attachListeners() {
        ...
        this.delegateElement.on('click', '.DropdownMenu [aria-haspopup]', this._closeMenu.bind(this), true);
        this.delegateElement.on('click', '.DropdownMenu [aria-haspopup]', this._adjustDropdownPosition.bind(this), true);
...
/******/);
$( "body" ).delegate( ".transcy-click-currency", "click", function() {
       console.log(11);
     });